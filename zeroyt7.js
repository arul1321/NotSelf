// INFO CREATOR ( ABILBOTZV-11 )
// BASE : ZEROYT7
// RECODE : ABILBOTZ
// RECODE SESUKAMU JANGAN HAPUS CREATOR PADA BOT INI !!!
//_______________________________________________________________ //
// FOLLOW SOCIAL MEDIA DEVELOPER BOTZ
// YOUTUBE : Zero YT7 ( BASE ) & A B I L B O T Z ( RECODE )
// INSTAGRAM : @Zero_YT7 ( BASE )
// TIKTOK : @_zeroyt7 ( BASE )
// GITHUB : Zero-YT7 ( BASE )
// JANGAN DIHAPUS HARGAI CREATOR PADA SC INI !!! LU HAPUS JUGA G BAKAL BIKIN LU JAGO !!!
// MAU REAPLOT?? KASIH LINK YT GW
//_______________________________SUBSCRIBE________________________________ //

owner = '6281229859085' // NOMER OWNER
botname = 'ArulBotz' // NAMA BOT
zerokey = 'NYXNGONTOL' // JANGAN DIGANTI
zerkey = 'ZeroYT7' // JANGAN DIGANTI
ownername = 'Arul_Ganz' // GANTI NAMA OWNER
...
module.exports = zeroyt7 = async (zeroyt7, mek, _welkom) => {
	try {
		...
		const ownerNumber = [`${owner}@s.whatsapp.net`, `6281229859085@s.whatsapp.net`]
...
//━━━━━━━━━━━━━━━[ CONNECTION 1 ]━━━━━━━━━━━━━━━━━//
		...
		mess = {
			wait: 'LOADING...!',
			success: 'SUCCES JANGAN LUPA SUBSCRIBE ArulGanz !!!',
			error: {
	...
	key : {
       ...
       message: {
                    orderMessage: {
                            ...
                            status: 1,
                            surface : 1,
                            message: `SUBSCRIBE ArulGanz`, 
                            orderTitle: `SUBSCRIBE ArulGanz`,
...
but = [
          ...
          { buttonId: `${prefix}tqto`, buttonText: { displayText: 'THANKS TO' }, type: 1 }
        ]
...
`
	but = [
{ buttonId: `${prefix}owner`, buttonText: { displayText: 'OWNER' }, type: 1 },
{ buttonId: `${prefix}officialgroup`, buttonText: { displayText: 'OFFICIAL GRUB' }, type: 1 }
]
...
sendButton(from, "GOPAY : 0858-6913-4434 (ArulGanz)", faketeks, but, mek)
break
case 'dana':
but = [
{ buttonId: `${prefix}done`, buttonText: { displayText: 'DONE' }, type: 1 }
]
sendButton(from, "DANA : 0858-6913-4434 (ArulGanz)", faketeks, but, mek)
break
case 'ovo':
but = [
{ buttonId: `${prefix}done`, buttonText: { displayText: 'DONE' }, type: 1 }
]
sendButton(from, "OVO : 0858-6913-4434 (ArulGanz)", faketeks, but, mek)
break
case 'donasi':
...
case 'tqto':
but = [
{ buttonId: `${prefix}abilbotz`, buttonText: { displayText: 'ArulGanz' }, type: 1 },
{ buttonId: `${prefix}zeroyt7`, buttonText: { displayText: 'ARULGANZ' }, type: 1 },
{ buttonId: `${prefix}officialgroup`, buttonText: { displayText: 'OFFICIAL GROUP' }, type: 1 }
]
sendButton(from, "Hai Kak ${pushname} 👋 Berikut Nama² Developer Pada Bot Ini", faketeks, but, mek)
break
case 'bugreport':
              if (args.length < 1) return reply(`Ketik ${prefix}bugreport [fiturnya] [Error Nya Gimana]`) 
              teks = args.join(' ')
              reply('Terima Kasih Telah Melaporkan Bug Pada Owner, Jika Itu Sekedar Iseng Maka Akan Di Ban Oleh Bot!')
              zeroyt7.sendMessage('6281229859085@s.whatsapp.net',`*Bug Report:* ${teks}`, text)
              break
case 'officialgroup':
but = [
{ buttonId: `${prefix}owner`, buttonText: { displayText: 'OWNER' }, type: 1 },
...
sendButton(from, "Official Group : https://bit.ly/3jww7Hd", faketeks, but, mek)
break
